...
func ListSharesByTarget(c *gin.Context) (*dto.PageResponse[*model.Share], *response.AppError) {
	...
	shares, total, err := dao.ListSharesByTarget(req.TargetType, req.TargetID, offset, pageSize)
	if err != nil {
