...
func ListLikesByTarget(ctx context.Context, req dto.QueryByTargetRequest) (*dto.PageResponse[*model.Like], error) {
	...
	likes, total, err := dao.ListLikesByTarget(ctx, req.TargetType, req.TargetID, offset, pageSize)
	if err != nil {
		return nil, err
	}
