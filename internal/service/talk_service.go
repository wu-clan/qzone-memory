...
func GetTalkList(c *gin.Context) (*dto.PageResponse[*model.Talk], *response.AppError) {
	...
	talks, total, err := dao.ListTalks(req.QQ, offset, pageSize)
	if err != nil {
...
func GetTalkDetail(c *gin.Context) (*model.Talk, *response.AppError) {
	...
	talk, err := dao.GetTalkByTalkID(req.TalkID)
	if err != nil {
